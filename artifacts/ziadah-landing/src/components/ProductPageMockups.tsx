      ...
      >
        <div
          style={{
            ...
            height: 90,
            borderRadius: 10,
            background: `linear-gradient(135deg, rgba(${colorToRgb(accentColor)},.15) 0%, rgba(52, 211, 153,.1) 100%)`,
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
            marginBottom: 8,
...
function BundleContent({ copy }: { copy: ProductPageMockupsCopy }) {
  return (
    <>
      <SectionDivider label={copy.dividerBundle} color="#34d399" />
      <div
        style={{
      ...
      >
        ...
        <AddToCartBtn color="#34d399" label={copy.addBundleToCart} full />
      </div>
    </>
  );
}
