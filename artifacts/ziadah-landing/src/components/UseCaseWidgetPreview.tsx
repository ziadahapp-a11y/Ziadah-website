  ...
  return (
    <div
      style={{
        ...
        border: "var(--uc-preview-border, 1px solid rgba(22, 163, 74,0.15))",
        borderRadius: 16,
        boxShadow: "var(--uc-preview-shadow, 0 8px 32px rgba(22, 163, 74,.06), 0 2px 8px rgba(0,0,0,.1), inset 0 1px 0 rgba(255,255,255,0.04))",
        overflow: "hidden",
        direction,
        width: "100%",
        maxWidth,
