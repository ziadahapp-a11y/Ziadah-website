...
export function ProductPageMockup() {
  ...
  const rowHi =
    "linear-gradient(90deg, rgba(34, 197, 125,.14) 0%, rgba(110, 231, 183,.09) 55%, rgba(255,255,255,.5) 100%)";
  const rowLo = "rgba(255,255,255,.72)";
  const borderSoft = "rgba(34, 197, 125,.14)";
  const borderHi = "rgba(34, 197, 125,.32)";
  return (
    <>
      ...
      <div
        style={{
          ...
          boxShadow: "0 4px 16px rgba(34, 197, 125,.07), inset 0 1px 0 rgba(255,255,255,.9)",
        }}
      >
        <div
          style={{
            height: 72,
            borderRadius: 10,
            background: `linear-gradient(145deg, ${accentLight}33 0%, ${accent}22 48%, rgba(34, 197, 125,.12) 100%)`,
            display: "flex",
            alignItems: "center",
      ...
      {[
        ...
        <div
          ...
          style={{
            ...
            alignItems: "center",
            boxShadow: o.hi ? "0 2px 12px rgba(34, 197, 125,.12)" : "inset 0 1px 0 rgba(255,255,255,.85)",
          }}
        >
            ...
            {o.tag ? (
              <span
                style={{
                  ...
                  padding: "2px 7px",
                  borderRadius: 6,
                  background: o.hi ? "rgba(34, 197, 125,.2)" : "rgba(34, 197, 125,.12)",
                  color: accent,
                  fontWeight: 800,
                }}
              >
      ...
      <div
        style={{
          ...
          padding: "9px 0",
          borderRadius: 10,
          background: "linear-gradient(135deg,#34d399,#22c57d 55%,#16a34a)",
          fontSize: 12,
          fontWeight: 900,
          color: "#fff",
          textAlign: "center",
          boxShadow: "0 6px 20px rgba(34, 197, 125,.35), inset 0 1px 0 rgba(255,255,255,.22)",
        }}
      >
        🛒 إضافة للسلة
      </div>
...
function CheckoutPageContent() {
  ...
  return (
    <>
      ...
      <div style={{ padding: "8px 0", borderRadius: 9, background: "linear-gradient(135deg,#10b981,rgba(16,185,129,.7))", textAlign: "center", fontSize: 12, fontWeight: 800, color: "#fff", boxShadow: "0 4px 12px rgba(16,185,129,.4)" }}>✅ إتمام الطلب الآن</div>
    </>
  );
}
...
function HomePageContent() {
  ...
  return (
    <>
      ...
      <div style={{ background: "rgba(34, 197, 125,.1)", border: "1px solid rgba(34, 197, 125,.22)", borderRadius: 10, padding: "9px 10px", marginBottom: 9 }}>
        ...
        <div style={{ display: "flex", gap: 5 }}>
          {["📿", "🕌", "🪔"].map((e, i) => (
            <div key={i} style={{ width: 32, height: 32, borderRadius: 8, background: "rgba(34, 197, 125,.12)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 15, border: "1px solid rgba(34, 197, 125,.18)" }}>{e}</div>
          ))}
        </div>
      </div>
      <div style={{ display: "flex", alignItems: "center", gap: 5, marginBottom: 7 }}>
      ...
      <div style={{ display: "flex", gap: 6, overflowX: "clip" }}>
        {[{ emoji: "🌿", name: "زيت بخور", price: "75 SAR" }, { emoji: "🎁", name: "طقم هدايا", price: "150 SAR" }, { emoji: "🪬", name: "حرز فضة", price: "90 SAR" }].map((p, i) => (
          <div key={i} style={{ minWidth: 68, background: "color-mix(in srgb, var(--bg) 55%, transparent)", border: "1px solid rgba(34, 197, 125,.14)", borderRadius: 9, padding: "6px 5px", textAlign: "center", flexShrink: 0 }}>
            <div style={{ height: 38, borderRadius: 6, background: "rgba(34, 197, 125,.1)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18, marginBottom: 4 }}>{p.emoji}</div>
            <p style={{ fontSize: 12, fontWeight: 700, color: "var(--t)", marginBottom: 2 }}>{p.name}</p>
            <span style={{ fontSize: 12, color: accent, fontWeight: 800 }}>{p.price}</span>
          </div>
        ))}
