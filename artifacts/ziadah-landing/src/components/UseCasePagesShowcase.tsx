...
function CheckoutPageContent() {
  ...
  return (
    <>
      ...
      <div style={{ background: "color-mix(in srgb, var(--bg) 55%, transparent)", border: "1px solid rgba(139, 92, 246,.15)", borderRadius: 10, padding: "8px 9px", marginBottom: 8 }}>
      ...
      <div style={{ background: "rgba(139, 92, 246,.07)", border: "1px solid rgba(139, 92, 246,.28)", borderRadius: 10, padding: "8px 9px", marginBottom: 8 }}>
        ...
        {[{ emoji: "🎁", name: "تغليف هدية فاخر", price: "15 SAR" }, { emoji: "🛡️", name: "ضمان إضافي سنة", price: "25 SAR" }].map((a, i) => (
          <div key={i} style={{ display: "flex", gap: 5, alignItems: "center", background: "color-mix(in srgb, var(--bg) 55%, transparent)", border: "1px solid rgba(139, 92, 246,.1)", borderRadius: 7, padding: "5px 6px", marginTop: 5 }}>
            <div style={{ width: 22, height: 22, borderRadius: 6, background: "rgba(139, 92, 246,.12)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 12 }}>{a.emoji}</div>
            <div style={{ flex: 1 }}>
            ...
            <div style={{ width: 15, height: 15, borderRadius: 4, border: "1.5px solid rgba(139, 92, 246,.5)", display: "flex", alignItems: "center", justifyContent: "center" }}>
              <span style={{ fontSize: 12, color: accent }}>+</span>
            </div>
          </div>
        ))}
      </div>
      <div style={{ padding: "8px 0", borderRadius: 9, background: "linear-gradient(135deg,#8b5cf6,rgba(139, 92, 246,.7))", textAlign: "center", fontSize: 12, fontWeight: 800, color: "#fff", boxShadow: "0 4px 12px rgba(139, 92, 246,.4)" }}> إتمام الطلب الآن</div>
    </>
  );
}
