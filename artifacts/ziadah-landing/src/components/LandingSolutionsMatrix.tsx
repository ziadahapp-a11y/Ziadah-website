        ...
        {group.entries.map((ent) => {
          ...
          return (
            <button
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.borderColor = "rgba(22, 163, 74,.35)";
                e.currentTarget.style.background = "rgba(22, 163, 74,.06)";
              }}
              onMouseLeave={(e) => {
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      padding: "10px 12px",
                      borderRadius: 14,
                      border: selected ? "2px solid rgba(22, 163, 74,.55)" : "1px solid var(--b2)",
                      background: selected ? "rgba(22, 163, 74,.1)" : "var(--s1)",
                      cursor: "pointer",
                      fontFamily: "var(--font)",
                      color: "var(--t)",
                      transition: "border-color .15s, background .15s",
                      boxShadow: selected ? "0 4px 14px rgba(22, 163, 74,.12)" : "none",
                    }}
                  >
                    <div
                      style={{
