    ...
    >
      <div style={{ textAlign: "center", marginBottom: 14 }}>
        ...
        <div style={{
          ...
          padding: "14px 24px",
          borderRadius: 14,
          border: "2px dashed rgba(52, 211, 153,.6)",
          background: "rgba(34, 197, 125,.1)",
          marginBottom: 12,
        }}>
          <div style={{ textAlign: "center" }}>
            <div style={{ fontSize: 28, fontWeight: 900, color: "#6ee7b7", lineHeight: 1 }}>{tr.discountAmount}</div>
            <div style={{ fontSize: 12, color: "var(--td)", marginTop: 2 }}>{tr.discountSub}</div>
          </div>
          <div style={{ width: 1, height: 40, background: "rgba(52, 211, 153,.3)" }} />
          <div style={{ textAlign: "center" }}>
