  ...
  return (
    <UseCaseWidgetPreview title="حزمة روتين الصباح" subtitle="وفّر ٥٠ ريال على المجموعة">
      <div style={{ marginBottom: 12 }}>
        <div style={{ fontSize: 14, color: "rgba(255,255,255,.5)", marginBottom: 10 }}>محتويات الحزمة:</div>
            ...
            <div key={i} style={{
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 5 }}>
                  <span style={{ fontSize: 14, color: "rgba(255,255,255,.35)", textDecoration: "line-through" }}>﷼{item.origPrice}</span>
                </div>
              </div>
              <div style={{
                width: 16,
      ...
      <div style={{
        ...
        <div>
          <div style={{ fontSize: 14, color: "rgba(255,255,255,.5)" }}>المجموع الأصلي</div>
          <div style={{ fontSize: 14, color: "rgba(255,255,255,.35)", textDecoration: "line-through", fontWeight: 700 }}>﷼٢٤٩</div>
        </div>
        ...
        <div style={{ textAlign: "left" }}>
          <div style={{ fontSize: 14, color: "rgba(255,255,255,.5)" }}>سعر الحزمة</div>
