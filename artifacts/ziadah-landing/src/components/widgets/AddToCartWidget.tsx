        ...
        {step === "recommend" && (
          <div>
            <div style={{
              ...
              <span style={{ fontSize: 12, color: "#10b981", fontWeight: 700 }}>{tr.addedTag}</span>
            </div>
            <div style={{
              padding: "12px",
              borderRadius: 12,
              ...
              <div style={{ fontSize: 12, color: "#34d399", fontWeight: 700, marginBottom: 8, letterSpacing: 0.5 }}>
                {tr.alsoLabel}
              </div>
              <div style={{ display: "flex", gap: 8, alignItems: "center", marginBottom: 10 }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ fontSize: 12, fontWeight: 900, color: "#6ee7b7", marginTop: 3 }}>{tr.suggestedPrice}</div>
                </div>
              </div>
              <button style={{
                ...
                border: "1px solid rgba(34, 197, 125,0.2)", cursor: "pointer",
              }}>
                {tr.btnAdd}
              </button>
            </div>
