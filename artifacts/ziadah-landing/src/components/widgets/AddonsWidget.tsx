...
export default function AddonsWidget() {
  const addons = [
    { emoji: "📱", name: "غلاف حماية للهاتف", price: "+٣٩ ر", checked: true },
    { emoji: "🔋", name: "شاحن لاسلكي سريع", price: "+٦٥ ر", checked: false },
    { emoji: "🎧", name: "سماعة لاسلكية", price: "+٨٩ ر", checked: true },
    { emoji: "🛡️", name: "واقي شاشة زجاجي", price: "+١٥ ر", checked: false },
  ];
  ...
  return (
    <UseCaseWidgetPreview title="إضافات مكملة للمنتج" subtitle="لاتنسَ تضيف المجموعة كاملة">
      ...
      <div style={{
        ...
        <span style={{ fontSize: 13, fontWeight: 800, color: "#7c3aed" }}>+١٢٨ ر</span>
      </div>
      <button style={{
        width: "100%",
        padding: "9px",
