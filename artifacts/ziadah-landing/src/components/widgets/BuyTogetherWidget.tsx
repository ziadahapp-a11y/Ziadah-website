        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          {tr.items.map((p, i) => (
            <div key={i} onClick={() => toggle(i)} style={{
              ...
              padding: "10px",
              borderRadius: 12,
              background: checked[i] ? "linear-gradient(135deg, rgba(34, 197, 125,.2), rgba(34, 197, 125,.08))" : "rgba(255,255,255,0.04)",
              border: checked[i] ? "1.5px solid rgba(52, 211, 153,.48)" : "1.5px solid rgba(255,255,255,0.09)",
              alignItems: "center",
              cursor: "pointer",
              ...
              <div style={{
                ...
                height: 36,
                borderRadius: 8,
                background: "linear-gradient(135deg, rgba(34, 197, 125,.24), rgba(34, 197, 125,.08))",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                fontSize: 18,
