  ...
  return (
    ...
    >
      <div style={{
        ...
        border: "1px solid rgba(34, 197, 125,.3)",
        borderRadius: 24, padding: 40, width: "100%", maxWidth: 500,
        position: "relative", direction: dir,
        boxShadow: "0 40px 100px rgba(0,0,0,.8), 0 0 60px rgba(34, 197, 125,.15)",
      }}>
        <button
          type="button"
          onClick={onClose}
          ...
          <>
            <div style={{ marginBottom: 28 }}>
              <div style={{
                ...
                background: "rgba(34, 197, 125,.15)", border: "1px solid rgba(34, 197, 125,.3)",
                display: "flex", alignItems: "center", justifyContent: "center",
                marginBottom: 16,
              }}>
                <svg width="24" height="24" viewBox="0 0 20 20" fill="none">
                  <path d="M10 2L3 7v9a2 2 0 002 2h10a2 2 0 002-2V7l-7-5zm0 2.36L15 8v8H5V8l5-3.64z" fill="rgba(52, 211, 153,.8)"/>
                </svg>
              </div>
            ...
            <form noValidate onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              <div>
                ...
                <input
                  ...
                  onFocus={e => e.currentTarget.style.borderColor = "rgba(34, 197, 125,.6)"}
              ...
              <button
                ...
                style={{
                  ...
                  background: sending ? "rgba(34, 197, 125,.4)" : "linear-gradient(135deg,#22c57d,#16a34a)",
                  border: "none", borderRadius: 50, color: "#fff",
                  fontFamily: "var(--font)", fontSize: 15, fontWeight: 700,
                  cursor: sending ? "not-allowed" : "pointer",
                  transition: "all .25s", marginTop: 4,
                  boxShadow: sending ? "none" : "0 0 30px rgba(34, 197, 125,.4)",
                }}
              >
