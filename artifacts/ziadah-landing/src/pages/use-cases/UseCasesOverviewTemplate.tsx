...
function getData(kind: UseCasesOverviewKind): UseCasePageData {
  const map: Record<UseCasesOverviewKind, UseCasePageData> = {
    "by-pages": {
      ...
      strategies: [
        { icon: "📄", title: "صفحة المنتج", desc: "توصيات مباشرة بجوار المنتج.", color: "#22c55e" },
        { icon: "🛒", title: "صفحة السلة", desc: "رفع قيمة الطلب قبل الإتمام داخل السلة.", color: "#06b6d4" },
        { icon: "💳", title: "صفحة الدفع", desc: "تحسين العرض في آخر خطوة قبل الإتمام.", color: "#22c55e" },
        { icon: "🙏", title: "صفحة الشكر", desc: "اقتراحات ما بعد الشراء لزيادة التكرار.", color: "#f59e0b" },
        { icon: "🏠", title: "الصفحة الرئيسية", desc: "تخصيص أول تجربة للزائر.", color: "#16a34a" },
      ...
      stats: [
        { value: "+32%", label: "زيادة متوسط السلة", color: "#22c55e" },
        { value: "+21%", label: "تحسن التحويل", color: "#06b6d4" },
        { value: "-18%", label: "انخفاض التخلي", color: "#22c55e" },
      ...
      strategiesEn: [
        { icon: "📄", title: "Product Page", desc: "Contextual recommendations near products.", color: "#22c55e" },
        { icon: "🛒", title: "Cart Page", desc: "Lift AOV inside the cart.", color: "#06b6d4" },
        { icon: "💳", title: "Checkout Page", desc: "Optimize offers before payment.", color: "#22c55e" },
        { icon: "🙏", title: "Thank You Page", desc: "Post-purchase recommendations.", color: "#f59e0b" },
        { icon: "🏠", title: "Home Page", desc: "Personalize the first touch.", color: "#16a34a" },
      ...
      statsEn: [
        { value: "+32%", label: "Average cart uplift", color: "#22c55e" },
        { value: "+21%", label: "Conversion improvement", color: "#06b6d4" },
        { value: "-18%", label: "Lower abandonment", color: "#22c55e" },
    ...
    "by-activity": {
      ...
      strategies: [
        { icon: "🔁", title: "Cross-Sell", desc: "منتجات مكملة بشكل ذكي.", color: "#22c55e" },
        { icon: "⬆️", title: "Upsell", desc: "بدائل أعلى قيمة بوقت مناسب.", color: "#06b6d4" },
        { icon: "➕", title: "إضافة للسلة", desc: "تحفيز اتخاذ القرار في لحظة الإضافة.", color: "#22c55e" },
        { icon: "➖", title: "إزالة من السلة", desc: "تقليل التردد قبل فقدان العميل.", color: "#f59e0b" },
      ],
      stats: [
        { value: "+27%", label: "تحسن قيمة الطلب", color: "#22c55e" },
        { value: "+19%", label: "تحسن معدل الإتمام", color: "#06b6d4" },
        { value: "-16%", label: "انخفاض الخروج", color: "#22c55e" },
      ...
      strategiesEn: [
        { icon: "🔁", title: "Cross-Sell", desc: "Smart complementary products.", color: "#22c55e" },
        { icon: "⬆️", title: "Upsell", desc: "Higher-value alternatives at the right time.", color: "#06b6d4" },
        { icon: "➕", title: "Add to Cart", desc: "Reinforce intent at add moment.", color: "#22c55e" },
        { icon: "➖", title: "Remove from Cart", desc: "Prevent loss before exit.", color: "#f59e0b" },
      ],
      statsEn: [
        { value: "+27%", label: "Order value uplift", color: "#22c55e" },
        { value: "+19%", label: "Checkout completion", color: "#06b6d4" },
        { value: "-16%", label: "Drop-off reduction", color: "#22c55e" },
    ...
    "by-presentation": {
      ...
      strategies: [
        { icon: "🧷", title: "منتجات ذات صلة", desc: "اقتراحات بجانب المنتج الرئيسي.", color: "#22c55e" },
        { icon: "💬", title: "Add-ons", desc: "خيارات إضافية خفيفة أثناء الشراء.", color: "#06b6d4" },
        { icon: "🤝", title: "اشترِ معًا", desc: "منتجات متوافقة في عرض واحد.", color: "#22c55e" },
        { icon: "📦", title: "Bundle Deals", desc: "حزم وكومبو بصفقة واضحة.", color: "#f59e0b" },
        { icon: "🛍️", title: "اشترِ أكثر ووفر أكثر", desc: "عروض كمية لزيادة السلة.", color: "#16a34a" },
      ],
      stats: [
        { value: "+24%", label: "قبول العروض", color: "#22c55e" },
        { value: "+17%", label: "زيادة عدد المنتجات", color: "#06b6d4" },
        { value: "+14%", label: "زيادة قيمة السلة", color: "#22c55e" },
      ...
      strategiesEn: [
        { icon: "🧷", title: "Related Products", desc: "Suggestions near the main item.", color: "#22c55e" },
        { icon: "💬", title: "Add-ons", desc: "Light options while buying.", color: "#06b6d4" },
        { icon: "🤝", title: "Buy Together", desc: "Compatible products in one offer.", color: "#22c55e" },
        { icon: "📦", title: "Bundle Deals", desc: "Clear package offers.", color: "#f59e0b" },
        { icon: "🛍️", title: "Buy More Save More", desc: "Quantity-based offers to increase cart value.", color: "#16a34a" },
      ],
      statsEn: [
        { value: "+24%", label: "Offer acceptance", color: "#22c55e" },
        { value: "+17%", label: "Items per order", color: "#06b6d4" },
        { value: "+14%", label: "AOV uplift", color: "#22c55e" },
    ...
    "by-goal": {
      ...
      strategies: [
        { icon: "🧺", title: "زيادة عدد منتجات السلة", desc: "دفع العميل لإضافة عناصر أكثر.", color: "#22c55e" },
        { icon: "💰", title: "رفع قيمة الطلب", desc: "عروض ذكية على الكميات والبدائل.", color: "#06b6d4" },
        { icon: "🚀", title: "تحسين التحويل", desc: "تقليل التردد في اللحظات الحساسة.", color: "#22c55e" },
        { icon: "🛡️", title: "تقليل التخلي", desc: "حماية الطلب من التسرب قبل الإتمام.", color: "#f59e0b" },
        { icon: "🚚", title: "عرض الشحن المجاني", desc: "تحفيز الإكمال بإبراز عتبة الشحن.", color: "#16a34a" },
        { icon: "🎟️", title: "عروض الكوبونات", desc: "تشجيع الشراء بقيمة مضافة واضحة.", color: "#4f46e5" },
      ],
      stats: [
        { value: "+29%", label: "تحسن القيمة", color: "#22c55e" },
        { value: "+22%", label: "تحسن الإتمام", color: "#06b6d4" },
        { value: "+31%", label: "نمو المنتجات/طلب", color: "#22c55e" },
      ...
      strategiesEn: [
        { icon: "🧺", title: "More Cart Items", desc: "Encourage customers to add more items.", color: "#22c55e" },
        { icon: "💰", title: "Higher AOV", desc: "Smart quantity and upgrade offers.", color: "#06b6d4" },
        { icon: "🚀", title: "Better Conversion", desc: "Reduce hesitation at key moments.", color: "#22c55e" },
        { icon: "🛡️", title: "Reduce Abandonment", desc: "Protect orders from drop-off before checkout.", color: "#f59e0b" },
        { icon: "🚚", title: "Free Shipping Display", desc: "Motivate completion with shipping threshold cues.", color: "#16a34a" },
        { icon: "🎟️", title: "Discount Coupon", desc: "Drive action with clear promotional value.", color: "#4f46e5" },
      ],
      statsEn: [
        { value: "+29%", label: "Value uplift", color: "#22c55e" },
        { value: "+22%", label: "Completion uplift", color: "#06b6d4" },
        { value: "+31%", label: "Items/order growth", color: "#22c55e" },
    ...
    "by-experience": {
      ...
      strategies: [
        { icon: "✨", title: "تخصيص تجربة العميل", desc: "تجربة مخصصة لكل زائر حسب سلوكه واهتمامه.", color: "#22c55e" },
      ],
      stats: [
        { value: "+26%", label: "تحسن التفاعل", color: "#22c55e" },
        { value: "+20%", label: "تحسن التحويل", color: "#06b6d4" },
        { value: "+18%", label: "تحسن العودة للشراء", color: "#22c55e" },
      ...
      strategiesEn: [
        { icon: "✨", title: "Customer Experience", desc: "Personalized journeys based on behavior and intent.", color: "#22c55e" },
      ],
      statsEn: [
        { value: "+26%", label: "Engagement uplift", color: "#22c55e" },
        { value: "+20%", label: "Conversion uplift", color: "#06b6d4" },
        { value: "+18%", label: "Repeat purchase uplift", color: "#22c55e" },
