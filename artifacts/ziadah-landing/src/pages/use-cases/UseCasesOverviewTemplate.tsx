...
function getData(kind: UseCasesOverviewKind): UseCasePageData {
  const map: Record<UseCasesOverviewKind, UseCasePageData> = {
    "by-pages": {
      ...
      strategies: [
        { icon: "📄", title: "صفحة المنتج", desc: "توصيات مباشرة بجوار المنتج.", color: "#34d399" },
        ...
        { icon: "🏠", title: "الصفحة الرئيسية", desc: "تخصيص أول تجربة للزائر.", color: "#22c57d" },
      ...
      stats: [
        { value: "+32%", label: "زيادة متوسط السلة", color: "#34d399" },
      ...
      strategiesEn: [
        { icon: "📄", title: "Product Page", desc: "Contextual recommendations near products.", color: "#34d399" },
        ...
        { icon: "🏠", title: "Home Page", desc: "Personalize the first touch.", color: "#22c57d" },
      ...
      statsEn: [
        { value: "+32%", label: "Average cart uplift", color: "#34d399" },
    ...
    "by-activity": {
      ...
      strategies: [
        { icon: "🔁", title: "Cross-Sell", desc: "منتجات مكملة بشكل ذكي.", color: "#34d399" },
      ...
      stats: [
        { value: "+27%", label: "تحسن قيمة الطلب", color: "#34d399" },
      ...
      strategiesEn: [
        { icon: "🔁", title: "Cross-Sell", desc: "Smart complementary products.", color: "#34d399" },
      ...
      statsEn: [
        { value: "+27%", label: "Order value uplift", color: "#34d399" },
    ...
    "by-presentation": {
      ...
      strategies: [
        { icon: "🧷", title: "منتجات ذات صلة", desc: "اقتراحات بجانب المنتج الرئيسي.", color: "#34d399" },
        ...
        { icon: "🛍️", title: "اشترِ أكثر ووفر أكثر", desc: "عروض كمية لزيادة السلة.", color: "#22c57d" },
      ],
      stats: [
        { value: "+24%", label: "قبول العروض", color: "#34d399" },
      ...
      strategiesEn: [
        { icon: "🧷", title: "Related Products", desc: "Suggestions near the main item.", color: "#34d399" },
        ...
        { icon: "🛍️", title: "Buy More Save More", desc: "Quantity-based offers to increase cart value.", color: "#22c57d" },
      ],
      statsEn: [
        { value: "+24%", label: "Offer acceptance", color: "#34d399" },
    ...
    "by-goal": {
      ...
      strategies: [
        { icon: "🧺", title: "زيادة عدد منتجات السلة", desc: "دفع العميل لإضافة عناصر أكثر.", color: "#34d399" },
        ...
        { icon: "🚚", title: "عرض الشحن المجاني", desc: "تحفيز الإكمال بإبراز عتبة الشحن.", color: "#22c57d" },
        { icon: "🎟️", title: "عروض الكوبونات", desc: "تشجيع الشراء بقيمة مضافة واضحة.", color: "#4f46e5" },
      ],
      stats: [
        { value: "+29%", label: "تحسن القيمة", color: "#34d399" },
      ...
      strategiesEn: [
        { icon: "🧺", title: "More Cart Items", desc: "Encourage customers to add more items.", color: "#34d399" },
        ...
        { icon: "🚚", title: "Free Shipping Display", desc: "Motivate completion with shipping threshold cues.", color: "#22c57d" },
        { icon: "🎟️", title: "Discount Coupon", desc: "Drive action with clear promotional value.", color: "#4f46e5" },
      ],
      statsEn: [
        { value: "+29%", label: "Value uplift", color: "#34d399" },
    ...
    "by-experience": {
      ...
      strategies: [
        { icon: "✨", title: "تخصيص تجربة العميل", desc: "تجربة مخصصة لكل زائر حسب سلوكه واهتمامه.", color: "#34d399" },
      ],
      stats: [
        { value: "+26%", label: "تحسن التفاعل", color: "#34d399" },
      ...
      strategiesEn: [
        { icon: "✨", title: "Customer Experience", desc: "Personalized journeys based on behavior and intent.", color: "#34d399" },
      ],
      statsEn: [
        { value: "+26%", label: "Engagement uplift", color: "#34d399" },
