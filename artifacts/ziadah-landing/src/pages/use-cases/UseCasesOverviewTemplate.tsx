  ...
  const map: Record<UseCasesOverviewKind, UseCasePageData> = {
    "by-pages": {
      ...
      strategies: [
        ...
        { icon: "🗂️", title: "صفحة التصنيف", desc: "عرض منتجات مكملة حسب الفئة.", color: "#4f46e5" , href: "/use-cases/category" },
      ...
      stats: [
        ...
        { value: "-18%", label: "انخفاض التخلي", color: "#8b5cf6" },
      ...
      strategiesEn: [
        ...
        { icon: "🗂️", title: "Category Page", desc: "Suggest complementary products by category.", color: "#4f46e5" , href: "/use-cases/category" },
      ...
      statsEn: [
        ...
        { value: "-18%", label: "Lower abandonment", color: "#8b5cf6" },
    ...
    "by-activity": {
      ...
      stats: [
        ...
        { value: "-16%", label: "انخفاض الخروج", color: "#8b5cf6" },
      ...
      statsEn: [
        ...
        { value: "-16%", label: "Drop-off reduction", color: "#8b5cf6" },
    ...
    "by-presentation": {
      ...
      stats: [
        ...
        { value: "+14%", label: "زيادة قيمة السلة", color: "#8b5cf6" },
      ...
      statsEn: [
        ...
        { value: "+14%", label: "AOV uplift", color: "#8b5cf6" },
    ...
    "by-goal": {
      ...
      strategies: [
        ...
        { icon: "🛡️", title: "تقليل التخلي", desc: "حماية الطلب من التسرب قبل الإتمام.", color: "#f59e0b" , href: "/use-cases/reduce-abandon" },
        { icon: "🚚", title: "عرض الشحن المجاني", desc: "تحفيز الإكمال بإبراز عتبة الشحن.", color: "#7c3aed" , href: "/use-cases/free-shipping" },
        { icon: "🎟️", title: "عروض الكوبونات", desc: "تشجيع الشراء بقيمة مضافة واضحة.", color: "#4f46e5" , href: "/use-cases/discount-coupon" },
      ],
      stats: [
        { value: "+29%", label: "تحسن القيمة", color: "#8b5cf6" },
        { value: "+22%", label: "تحسن الإتمام", color: "#06b6d4" },
        { value: "+31%", label: "نمو المنتجات/طلب", color: "#8b5cf6" },
      ...
      strategiesEn: [
        ...
        { icon: "🛡️", title: "Reduce Abandonment", desc: "Protect orders from drop-off before checkout.", color: "#f59e0b" , href: "/use-cases/reduce-abandon" },
      ...
      statsEn: [
        ...
        { value: "+31%", label: "Items/order growth", color: "#8b5cf6" },
    ...
    "by-experience": {
      ...
      stats: [
        ...
        { value: "+18%", label: "تحسن العودة للشراء", color: "#8b5cf6" },
      ...
      statsEn: [
        ...
        { value: "+18%", label: "Repeat purchase uplift", color: "#8b5cf6" },
