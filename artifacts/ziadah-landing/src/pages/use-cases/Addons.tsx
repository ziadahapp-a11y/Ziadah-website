...
const data: UseCasePageData = {
  ...
  exampleScenario: {
    ...
    steps: [
      "📱 إلكترونيات: عميل يضيف هاتف للسلة → تظهر قائمة: [✓] غلاف حماية +٣٩ ر، [✓] واقي شاشة +١٥ ر، [ ] سماعة لاسلكية +٨٩ ر — يختار ويرى الإجمالي يتحدث.",
      "🌿 عناية: عميلة تشتري شامبو → تُعرض إضافات: [✓] بلسم مكمل +٢٨ ر، [ ] ماسك أسبوعي +٤٥ ر، [✓] سيروم تقوية +٦٢ ر.",
      "🎮 ألعاب: عميل يشتري جهاز تحكم → يرى: [✓] حقيبة حمل +٣٥ ر، [✓] بطاريات شحن +٢٩ ر، [ ] غطاء زلق مانع +١٩ ر.",
      "🍕 مطعم: عميل يطلب بيتزا → يختار من: [✓] صوص إضافي +٦ ر، [✓] حافة جبن +١٢ ر، [ ] مشروب +١٥ ر.",
    ],
