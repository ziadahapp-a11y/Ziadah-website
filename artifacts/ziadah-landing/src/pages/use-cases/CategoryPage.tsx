...
const data: UseCasePageData = {
  ...
  stats: [
    { value: "+٢٧٪", label: "معدل الانتقال من التصنيف للمنتج", color: "#a855f7" },
    { value: "+٣٣٪", label: "معدل إضافة للسلة", color: "#10b981" },
    { value: "+٢١٪", label: "متوسط قيمة الطلب", color: "#06b6d4" },
    { value: "-٢٤٪", label: "وقت اتخاذ قرار الشراء", color: "#ec4899" },
  ],
  exampleScenario: {
    title: "عميل يتصفح تصنيف 'أجهزة الصوت'",
    steps: [
      "يفتح العميل تصنيف أجهزة الصوت ويرى ٤٠ منتجاً.",
      "زيادة يعرف من تاريخه أنه مهتم بالجودة وعنده ميزانية متوسطة (سبق أن اشترى منتجات بين ٣٠٠-٦٠٠ ريال).",
      "يُعيد ترتيب المنتجات: السماعات في نطاق ميزانيته تظهر أولاً، مع شارة 'الأكثر مبيعاً هذا الأسبوع' على أحدها.",
      "يظهر بطاقة كومبو: 'سماعة + حامل + كابل شحن بخصم ١٥٪'.",
    ],
