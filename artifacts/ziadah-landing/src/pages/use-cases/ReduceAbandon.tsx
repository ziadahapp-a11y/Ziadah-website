...
const data: UseCasePageData = {
  ...
  exampleScenario: {
    ...
    steps: [
      "عميلة أضافت فستاناً بـ 380 ريال للسلة وجلست 4 دقائق دون تقدم.",
      "زيادة يكتشف أن وقت التردد تجاوز الحد — يُشغّل بروتوكول الإنقاذ.",
      "يظهر بنر خفيف: 'متجر حصري لك: خصم 10٪ لمدة 12 دقيقة فقط'.",
      "العميلة لم تغادر — شريط الشحن يقول 'أضف 20 ريال للشحن المجاني' فأضافت إكسسواراً صغيراً.",
    ],
    result: "أتمّت الشراء بقيمة 440 ريال بدلاً من التخلي عن 380 ريال — استرداد قيمة الطلب وزيادته في نفس الوقت.",
  },
  extraSections: (
