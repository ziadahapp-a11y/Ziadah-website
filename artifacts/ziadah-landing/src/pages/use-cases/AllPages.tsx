...
const data: UseCasePageData = {
  ...
  whatWeDoTitle: "تغطية ٣٦٠ درجة في رحلة العميل الكاملة",
  whatWeDoDesc:
  ...
  stats: [
    { value: "+٤٥٪", label: "متوسط الزيادة في الإيرادات", color: "#a855f7" },
    { value: "+٣٨٪", label: "متوسط قيمة الطلب", color: "#06b6d4" },
    { value: "-٣٥٪", label: "معدل التخلي عن السلة", color: "#ec4899" },
    { value: "+٥٢٪", label: "معدل الشراء المتكرر", color: "#10b981" },
  ],
  exampleScenario: {
    ...
    steps: [
      ...
      "يفتح صفحة منتج: يرى حزمة روتين كاملة كومبو بتوفير ٢٠٪.",
      "يضيف للسلة: يظهر له 'أضف ٢٥ ريال للشحن المجاني' فيضيف منتجاً صغيراً.",
      "بعد الشراء: صفحة شكر بكوبون ١٥٪ لطلبه القادم خلال ٤٨ ساعة.",
    ],
    result: "قيمة الطلب ارتفعت ٥٥٪ مقارنة بالنية الأصلية، والعميل عاد خلال ٣٦ ساعة باستخدام الكوبون.",
  },
