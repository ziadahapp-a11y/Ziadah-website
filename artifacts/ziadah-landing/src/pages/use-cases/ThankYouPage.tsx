...
const data: UseCasePageData = {
  ...
  strategies: [
    ...
    },
    {
      ...
      desc: "يمنح العميل كوبون خصم لطلبه القادم مع مدة محدودة (٢٤-٤٨ ساعة) لخلق شعور بالعجلة وإعادته للمتجر.",
      color: "#f59e0b",
    },
    {
      icon: "❤️",
  ...
  stats: [
    { value: "+٤٨٪", label: "معدل الشراء المتكرر", color: "#a855f7" },
    { value: "+٢٦٪", label: "قيمة الطلب الثاني", color: "#06b6d4" },
    { value: "+٣٥٪", label: "معدل استخدام كوبون العودة", color: "#10b981" },
    { value: "+٤٢٪", label: "رضا العميل على المدى البعيد", color: "#f59e0b" },
  ],
  exampleScenario: {
    title: "عميل اشترى هاتفاً جديداً",
    steps: [
      "العميل أتم شراء هاتف Galaxy بسعر ١٨٠٠ ريال.",
      "تظهر له صفحة شكر مخصصة من زيادة بدلاً من الصفحة الجامدة المعتادة.",
      "يظهر له: 'عملاء اشتروا هذا الهاتف أضافوا أيضاً → واقي شاشة + غلاف + سماعة بلوتوث بحزمة ٢٨٠ ريال'.",
      "يظهر أيضاً كوبون ١٥٪ خصم لأي طلب خلال ٤٨ ساعة القادمة.",
    ],
    result: "٣٨٪ من هؤلاء العملاء أضافوا الإكسسوارات فوراً، و٢٢٪ عادوا خلال ٤٨ ساعة باستخدام الكوبون.",
  },
