...
const data: UseCasePageData = {
  ...
  exampleScenario: {
    ...
    steps: [
      "العميلة اختارت فاونديشن بـ 110 ر.س وضغطت 'أضف للسلة'.",
      "رصد زيادة اللحظة وعرض فوراً: 'عميلات اشترين هذا الفاونديشن اشترين أيضاً برايمر التثبيت بـ 55 ر.س'.",
    ...
    result: "قيمة الطلب ارتفعت من 110 إلى 165 ر.س بقرار شراء لم تخطط له العميلة — لكنها سعيدة به.",
  },
  extraSections: (isAr) => (
    <UseCaseLiveShowcase
      isAr={isAr}
