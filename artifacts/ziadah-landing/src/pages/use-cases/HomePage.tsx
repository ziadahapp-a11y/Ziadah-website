...
const data: UseCasePageData = {
  ...
  stats: [
    { value: "+34%", label: "وقت التصفح في الموقع", color: "#22c55e" },
    { value: "+29%", label: "معدل الانتقال للمنتجات", color: "#06b6d4" },
    { value: "+22%", label: "معدل التحويل للعملاء العائدين", color: "#22c55e" },
  ...
  statsEn: [
    { value: "+34%", label: "Browse time on site", color: "#22c55e" },
    { value: "+29%", label: "Product click-through rate", color: "#06b6d4" },
    { value: "+22%", label: "Returning customer conversion rate", color: "#22c55e" },
