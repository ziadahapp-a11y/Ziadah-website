...
const data: UseCasePageData = {
  hero: {
    ...
    tagline: "كل ١٪ في CVR = آلاف الريالات شهرياً",
    icon: "📈",
  },
  whatWeDoTitle: "لماذا معدل التحويل أكثر أهمية من عدد الزوار؟",
  whatWeDoDesc:
    "المتجر الذي لديه ١٠٠٠ زائر بمعدل تحويل ٣٪ يحقق ٣٠ طلباً. رفع معدل التحويل لـ ٥٪ يعني ٥٠ طلباً — بنفس ميزانية الإعلانات. معدل التحويل في المتاجر الإلكترونية العربية يتراوح بين ١-٣٪ في المتوسط. زيادة يرفعه عبر منظومة متكاملة: تجربة مخصصة تزيل الاحتكاك، عروض موجّهة تُقلّل التردد، دليل اجتماعي يبني الثقة، وحوافز ذكية في اللحظة المناسبة.",
  ...
  strategies: [
    ...
    },
    {
      ...
      desc: "أكثر من ٧٠٪ من تصفح المتاجر يأتي من الهاتف. زيادة يُحسّن ظهور التوصيات ويجعلها سهلة التفاعل على الشاشات الصغيرة.",
      color: "#06b6d4",
    },
  ],
  stats: [
    { value: "+٢٥٪", label: "معدل التحويل الإجمالي", color: "#a855f7" },
    { value: "-٤٠٪", label: "وقت اتخاذ قرار الشراء", color: "#06b6d4" },
    { value: "+٣٢٪", label: "معدل تحويل الزوار الجدد", color: "#10b981" },
    { value: "+٤٥٪", label: "معدل تحويل العملاء العائدين", color: "#f59e0b" },
  ],
  exampleScenario: {
    title: "حساب تأثير رفع CVR بـ ٢٪",
    steps: [
      "متجر أزياء يستقبل ٨,٠٠٠ زائر شهرياً بمعدل تحويل ٢٪ = ١٦٠ طلباً.",
      "بعد تفعيل زيادة: التخصيص وعروض الكوبون الأول ترفع CVR لـ ٤٪.",
      "نفس ٨,٠٠٠ زائر → ٣٢٠ طلباً بمتوسط ٤٠٠ ريال = ١٢٨,٠٠٠ ريال.",
      "الإيراد السابق: ١٦٠ × ٤٠٠ = ٦٤,٠٠٠ ريال. الزيادة: ٦٤,٠٠٠ ريال شهرياً.",
    ],
    result: "مضاعفة الإيراد بدون إنفاق ريال واحد إضافي على الإعلانات — فقط بتحسين معدل التحويل.",
  },
  extraSections: (
  ...
  ctaDesc: "رفع CVR بنسبة صغيرة يساوي آلاف الريالات شهرياً — فعّل زيادة الآن.",
};
