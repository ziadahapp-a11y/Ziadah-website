...
const data: UseCasePageData = {
  ...
  exampleScenario: {
    ...
    steps: [
      ...
      "نفس 8,000 زائر → 320 طلباً بمتوسط 400 ر.س = 128,000 ر.س.",
      "الإيراد السابق: 160 × 400 = 64,000 ر.س. الزيادة: 64,000 ر.س شهرياً.",
    ],
    result: "مضاعفة الإيراد بدون إنفاق ر.س واحد إضافي على الإعلانات — فقط بتحسين معدل التحويل.",
  },
  extraSections: (isAr) => (
    <>
      <UseCaseLiveShowcase
  ...
  ctaDesc: "رفع CVR بنسبة صغيرة يساوي آلاف ر.س شهرياً — فعّل زيادة الآن.",
  heroEn: {
    tag: "By Goals",
