...
const data: UseCasePageData = {
  hero: {
    ...
    tagline: "كل 1٪ في CVR = آلاف الريالات شهرياً",
    icon: "📈",
  },
  ...
  exampleScenario: {
    ...
    steps: [
      ...
      "نفس 8,000 زائر → 320 طلباً بمتوسط 400 ريال = 128,000 ريال.",
      "الإيراد السابق: 160 × 400 = 64,000 ريال. الزيادة: 64,000 ريال شهرياً.",
    ],
