...
const data: UseCasePageData = {
            ...
            <div style={{ background: "var(--s1)", border: "1px solid var(--b1)", borderRadius: 20, padding: "36px 40px", backdropFilter: "blur(24px)", width: "100%" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(220px,1fr))", gap: 24 }}>
                ...
                <div style={{ padding: "24px 28px", background: "rgba(52, 211, 153,.05)", border: "1px solid rgba(52, 211, 153,.15)", borderRadius: 14 }}>
                  <div style={{ fontSize: 18, fontWeight: 800, color: "#34d399", marginBottom: 12 }}>{isAr ? "⬆️ البيع البديل (Upsell)" : "⬆️ Upselling"}</div>
                  <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: 8 }}>
                    {(isAr
  ...
  statsEn: [
    { value: "+32%", label: "Average number of products in cart", color: "#34d399" },
