...
const data: UseCasePageData = {
  ...
  stats: [
    { value: "+٣٢٪", label: "متوسط عدد المنتجات في السلة", color: "#a855f7" },
    { value: "+٢٨٪", label: "متوسط قيمة الطلب", color: "#06b6d4" },
    { value: "+٤١٪", label: "معدل قبول التوصية", color: "#10b981" },
    { value: "+١٩٪", label: "رضا العملاء عن التجربة", color: "#f59e0b" },
  ],
  exampleScenario: {
    ...
    result: "في جميع هذه الأمثلة، معدل قبول الاقتراح المتقاطع بين ٢٥ و٤٥٪ — كل قبول واحد يساوي طلباً إضافياً بدون تكلفة تسويق.",
  },
  extraSections: (
