...
const data: UseCasePageData = {
  ...
  exampleScenario: {
    ...
    steps: [
      "💄 تجميل: حزمة 'روتين الصباح' = غسول + سيروم + مرطب بـ ١٩٩ ⃁ بدلاً من ٢٤٩ ⃁ (توفير ٥٠ ⃁) — عرض واضح يقنع بالقيمة.",
      "💻 إلكترونيات: حزمة 'الإنتاجية' = لابتوب + ماوس + حقيبة بـ ١٨٩٩ ⃁ بدلاً من ٢١٥٠ ⃁ — التوفير الكبير يُبرر القرار الفوري.",
      "🍔 مطعم: وجبة عائلية = ٤ برغر + ٤ مشروبات + بطاطس كبيرة بـ ١١٩ ⃁ بدلاً من ١٤٨ ⃁ — يُناسب قرارات العائلة السريعة.",
      "🧴 رعاية شعر: حزمة 'شعر صحي' = شامبو + بلسم + ماسك أسبوعي بـ ٨٩ ⃁ بدلاً من ١١٢ ⃁ — توفير ٢٣ ⃁ يُقنع العميلة بالطقم الكامل.",
    ],
  ...
  extraSections: (
    ...
    <section style={{ position: "relative", zIndex: 2, padding: "0 5% 60px" }}>
      <div style={{ maxWidth: 900, margin: "0 auto", textAlign: "center" }}>
        ...
        <p style={{ fontSize: 14, color: "var(--tm)", marginBottom: 32, lineHeight: 1.7 }}>هكذا تبدو واجهة ويدجت الحزمة كما يراها عميلك فعلياً</p>
        <BundleDealsWidget />
      </div>
    </section>
    <section style={{ position: "relative", zIndex: 2, padding: "0 5% 60px" }}>
