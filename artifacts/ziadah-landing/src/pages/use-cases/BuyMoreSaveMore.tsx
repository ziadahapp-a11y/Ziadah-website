...
const data: UseCasePageData = {
  ...
  strategies: [
    {
      ...
      desc: "يعرض جدولاً واضحاً: ١ قطعة = ٤٩ ر | ٢ قطعة = ٤٤ ر لكل قطعة | ٣+ = ٣٩ ر لكل قطعة — العميل يرى الفرق مباشرة.",
      color: "#a855f7",
    },
    {
      icon: "🔋",
      title: "شريط التقدم نحو التوفير",
      desc: "يعرض شريطاً بصرياً يُظهر للعميل كم تبقى لتصل للشريحة التالية — 'أضف قطعة واحدة ووفّر ٣٠ ر إضافية'.",
      color: "#06b6d4",
    },
    {
      icon: "🎯",
  ...
  exampleScenario: {
    ...
    steps: [
      "☕ بن وقهوة: كيس قهوة ٢٥٠ غ = ٤٩ ر / كيسين = ٨٩ ر (توفير ٩ ر) / ٣ أكياس = ١١٩ ر (توفير ٢٨ ر) — شريط يُظهر 'أضف كيساً واحداً أكثر لتوفير ٢٨ ريال'.",
      "🧴 منظفات منزلية: منظف ليتر = ٢٢ ر / ٣ عبوات = ١٩ ر للعبوة / ٦ عبوات = ١٦ ر للعبوة — جدول شرائح واضح بجانب المنتج.",
      "💊 مكملات غذائية: علبة بروتين = ١٤٩ ر / علبتان = ١٣٩ ر لكل علبة / ٣ علب = ١٢٥ ر لكل علبة — مع توضيح 'كفاية ٣ أشهر بسعر أشهر إضافية'.",
      "🖊️ قرطاسية: قلم = ٨ ر / عبوة ٦ أقلام = ٤٢ ر (توفير ٦ ر) / علبة ١٢ قلم = ٧٢ ر (توفير ٢٤ ر) — خيارات الكمية بأزرار واضحة.",
    ],
