...
const stories = [
  {
    ...
    results: [
      "ارتفع متوسط قيمة السلة من 90 إلى 120 ريال",
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: "إجمالي المبيعات", value: "1.02M ر.س", color: "#06b6d4" },
    ...
    results: [
      ...
      "1,024,379 ريال إجمالي مبيعات محققة",
  ...
  },
  {
    ...
    results: [
      "ارتفع متوسط الطلب من 160 إلى 210 ريال",
  ...
  },
  {
    ...
    results: [
      "ارتفع متوسط الطلب من 120 إلى 170 ريال",
  ...
  },
  {
    ...
    results: [
      "ارتفع متوسط الطلب من 220 إلى 295 ريال",
  ...
  },
  {
    ...
    strategy: "تفعيل نوافذ تسويقية بهدف إضافة المنتجات المقترحة بخصم إضافي عند إضافة منتج للسلة.",
    results: [
      "ارتفع متوسط الطلب من 350 إلى 450 ريال",
  ...
  },
  {
    ...
    results: [
      ...
      "ارتفع متوسط الطلب من 190 إلى 240 ريال",
  ...
  },
  {
    ...
    results: [
      "ارتفع متوسط الطلب من 80 إلى 125 ريال",
  ...
  },
  {
    ...
    results: [
      ...
      "ارتفع متوسط الطلب من 130 إلى 170 ريال",
    ],
  },
  {
    ...
    results: [
      ...
      "ارتفع متوسط التبرع من 50 إلى 70 ريال",
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: "إجمالي المبيعات", value: "543,000 ر.س", color: "#06b6d4" },
      { label: "توقيت ذكي للنافذة", value: "✓", color: "#10b981" },
      { label: "كود خصم فعّال", value: "✓", color: "#f59e0b" },
    ],
    quote: "كود الخصم 5٪ كان بسيطاً لكن فعله كان كبيراً. العملاء الذين كانوا يترددون صاروا يكملون الطلب مباشرة. النتيجة 716 تحويل و543 ألف ريال مبيعات إضافية.",
    ...
    results: [
      ...
      "543,000 ريال إجمالي مبيعات محققة",
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: "إجمالي المبيعات", value: "248,816 ر.س", color: "#06b6d4" },
      { label: "استرداد لحظة الحذف", value: "✓", color: "#10b981" },
      { label: "حملة ذكية موجهة", value: "✓", color: "#f59e0b" },
    ],
    quote: "الفكرة كانت ذكية — تقدم للعميل خصماً بالضبط لما يحاول يحذف المنتج من السلة. هذا التوقيت غيّر كل شيء. 1,122 تحويل و248 ألف ريال ما كانت لتحصل بدون زيادة.",
    ...
    results: [
      ...
      "248,816 ريال إجمالي مبيعات محققة",
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: "إجمالي المبيعات", value: "932,517 ر.س", color: "#06b6d4" },
    ...
    results: [
      ...
      "932,517 ريال إجمالي مبيعات محققة",
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: "إجمالي المبيعات", value: "704,676 ر.س", color: "#06b6d4" },
    ...
    results: [
      ...
      "704,676 ريال إجمالي مبيعات محققة",
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: "إجمالي المبيعات", value: "77,000 ر.س", color: "#06b6d4" },
    ...
    results: [
      ...
      "77,000 ريال إجمالي مبيعات محققة",
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: "إجمالي المبيعات", value: "75,722 ر.س", color: "#06b6d4" },
      { label: "استرداد لحظة الحذف", value: "✓", color: "#10b981" },
    ...
    results: [
      ...
      "75,722 ريال إجمالي مبيعات محققة",
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: "إجمالي المبيعات", value: "247,438 ر.س", color: "#06b6d4" },
      { label: "ترويج فعّال للمنتجات الجديدة", value: "✓", color: "#10b981" },
      { label: "خصومات مستهدفة", value: "✓", color: "#f59e0b" },
    ],
    quote: "إطلاق منتجات جديدة كان تحدياً دائماً. زيادة حل المشكلة بنافذة ذكية تعرض المنتج الجديد بخصم في اللحظة المناسبة وتحفز العميل على الإتمام. النتيجة 655 تحويل و247 ألف ريال.",
    person: "فريق كلارا",
    ...
    results: [
      ...
      "247,438 ريال إجمالي مبيعات محققة",
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: "إجمالي المبيعات", value: "41,000 ر.س", color: "#06b6d4" },
    ...
    results: [
      ...
      "41,000 ريال إجمالي مبيعات محققة",
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: "إجمالي المبيعات", value: "119,903 ر.س", color: "#06b6d4" },
    ...
    results: [
      ...
      "119,903 ريال إجمالي مبيعات محققة",
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: "إجمالي المبيعات", value: "135,382 ر.س", color: "#06b6d4" },
    ...
    results: [
      ...
      "135,382 ريال إجمالي مبيعات محققة",
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: "إجمالي المبيعات", value: "76,257 ر.س", color: "#06b6d4" },
    ...
    results: [
      ...
      "76,257 ريال إجمالي مبيعات محققة",
