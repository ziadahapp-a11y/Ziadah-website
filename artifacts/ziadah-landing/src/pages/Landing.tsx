      ...
      <section className="hero">
        ...
        <div className="hero-in">
          ...
          <h1 className="ht text-[72px]">
            ...
            <span className="grad mt-[0px] mb-[0px] pt-[10px] pb-[10px]">
              أخبر منك بعميلك
            </span>
          </h1>
          ...
          <div className="gp-grid">
              ...
              <div className="gp-card">
                ...
                <div className="gp-items">
                  {[
                    ...
                    ["عرض الكميات (Buy 2 / Buy 3)", "تحفيز الشراء بكميات أكبر"],
                    ["استبدال المنتج", "عرض بديل أفضل أو أعلى قيمة"],
                    ["زيادة قيمة السلة", "رفع المبلغ الإجمالي لكل طلب"],
                    ["إعطاء كود خصم", "تحفيز إتمام الشراء بعرض خاص"],
                  ].map(([t, s]) => (
            ...
            <GlassCard className="rv d2">
              <div className="gp-card">
                ...
                <div className="gp-items">
                  {[
                    ["منتجات ذات صلة", "مقترحة بناءً على تصفح العميل"],
                    ["إضافات (Add-ons)", "منتجات مكملة للمنتج الأساسي"],
                    ["اشتروا مع بعض", "تجميع منتجات يشتريها العملاء معاً"],
                    ["Combo", "باقات ذكية بسعر موحد مغري"],
                    ["اشتر أكثر ووفر أكثر", "تصاعد الخصم مع زيادة الكمية"],
                  ].map(([t, s]) => (
                    <div key={t} className="gp-row">
            ...
            >
              ...
              <div>
                <div className="gp-banner-t">
                  الذكاء الاصطناعي يجمع كل شيء تلقائياً
                </div>
                <div className="gp-banner-d">
                  ما تحتاج تختار هدفاً أو طريقة عرض يدوياً. زيادة يحلل كل عميل
                  ويختار الهدف المناسب + طريقة العرض الأنسب - لوحده، بدون أي
                  تدخل منك، ويتحسن مع كل طلب جديد.
                </div>
              </div>
            </GlassCard>
          </div>
