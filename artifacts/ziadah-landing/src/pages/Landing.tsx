            ...
            <div className="ld-fallback" aria-hidden>
              <div className="ld-fallback-inner">
                <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
                  <rect width="40" height="40" rx="12" fill="rgba(22, 163, 74,.15)"/>
                  <path d="M14 20h12M22 15l5 5-5 5" stroke="#22c55e" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
...
function DemoFlowSection({ lang, tr }: { lang: string; tr: Record<string, string> }) {
  const isAr = lang === "ar";
  const nasserSigs = [
    { c: "#22c55e", t: tr.demoMaleSig1 },
    { c: "#06b6d4", t: tr.demoMaleSig2 },
    { c: "#22c55e", t: tr.demoMaleSig3 },
  ];
  const nouraSigs = [
    { c: "#ec4899", t: tr.demoFemaleSig1 },
    { c: "#22c55e", t: tr.demoFemaleSig2 },
        ...
        <div className="dfs-top">
          ...
          <div className="dfs-engine">
            ...
            <svg width="38" height="38" viewBox="0 0 32 32" fill="none" aria-hidden="true">
              <circle cx="16" cy="16" r="14" fill="rgba(22, 163, 74,.22)" stroke="rgba(34, 197, 94,.6)" strokeWidth="1.5" />
              <path d="M16 7 L11 21 L16 17 L21 21 Z" fill="rgba(34, 197, 94,.95)" />
        ...
        <div className="dfs-recs">
          ...
          <div className="dfs-rec dfs-rec-p rv d3">
            ...
            <div className="demo-suggs">
              ...
              <div className="demo-sugg">
                <div className="demo-si" style={{ background: "rgba(34, 197, 94,.07)", border: "1px solid rgba(34, 197, 94,.15)" }}>
                  <svg width="18" height="18" viewBox="0 0 18 18" fill="none"><rect x="3" y="7" width="12" height="6" rx="2" fill="rgba(34, 197, 94,.15)" stroke="rgba(34, 197, 94,.5)" strokeWidth="1" /><circle cx="6.5" cy="10" r="1.2" fill="rgba(34, 197, 94,.5)" /><circle cx="11.5" cy="10" r="1.2" fill="rgba(34, 197, 94,.5)" /></svg>
                </div>
          ...
          <div className="dfs-rec dfs-rec-pk rv d4">
            ...
            <div className="demo-suggs">
              ...
              <div className="demo-sugg">
                <div className="demo-si" style={{ background: "rgba(34, 197, 94,.07)", border: "1px solid rgba(34, 197, 94,.15)" }}>
                  <svg width="18" height="18" viewBox="0 0 18 18" fill="none"><rect x="5" y="3" width="8" height="11" rx="2" fill="rgba(34, 197, 94,.12)" stroke="rgba(34, 197, 94,.4)" strokeWidth="1" /><ellipse cx="9" cy="14.5" rx="3" ry="1.5" fill="rgba(34, 197, 94,.08)" stroke="rgba(34, 197, 94,.3)" strokeWidth="1" /></svg>
                </div>
...
export default function Landing() {
  ...
  const row1Colors = [
    ...
    "linear-gradient(135deg,#16a34a,#4f46e5)",
  ...
  return (
    <>
      ...
      <PageShell>
        ...
        <div id="zd-curR" className="desktop-only" style={{ width: 36, height: 36, border: "1px solid rgba(34, 197, 94,.4)", borderRadius: "50%", position: "fixed", pointerEvents: "none", zIndex: 9998, transition: "all .3s", top: -999, left: -999 }} />
        {/* NAV */}
        ...
        <section id="reports" className="landing-white-violet">
          <div className="wrap">
            ...
            <div className="reports-grid">
              ...
              <GlassCard className="rv d1" style={{ padding: "var(--card-pad-lg)", minHeight: "100%" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 24 }}>
                  <div style={{ width: 44, height: 44, borderRadius: 14, background: "rgba(22, 163, 74,.12)", border: "1px solid rgba(22, 163, 74,.25)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
                      <rect x="3" y="3" width="16" height="16" rx="3" fill="rgba(22, 163, 74,.12)" stroke="rgba(34, 197, 94,.45)" strokeWidth="1.4"/>
                      <line x1="7" y1="8" x2="15" y2="8" stroke="rgba(34, 197, 94,.4)" strokeWidth="1.3" strokeLinecap="round"/>
                      <line x1="7" y1="11" x2="15" y2="11" stroke="rgba(34, 197, 94,.7)" strokeWidth="1.6" strokeLinecap="round"/>
                      <line x1="7" y1="14" x2="11" y2="14" stroke="rgba(34, 197, 94,.4)" strokeWidth="1.3" strokeLinecap="round"/>
                    </svg>
                  </div>
                  <div>
                ...
                {/* Campaign name bar */}
                <div style={{ padding: "10px 14px", background: "rgba(22, 163, 74,.06)", border: "1px solid rgba(22, 163, 74,.15)", borderRadius: 10, marginBottom: 16, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    <div style={{ width: 6, height: 6, borderRadius: "50%", background: "#22c55e", boxShadow: "0 0 6px #22c55e" }}/>
                    <span style={{ fontSize: 13, fontWeight: 700 }}>{tr.landing.reportsCampaignName}</span>
                  </div>
                  <span style={{ fontSize: 11, color: "var(--p4)", fontWeight: 700, background: "rgba(34, 197, 94,.1)", border: "1px solid rgba(34, 197, 94,.2)", padding: "2px 10px", borderRadius: 50 }}>{tr.landing.reportsCampaignActive}</span>
                </div>
                ...
                <div style={{ marginTop: 16, padding: "12px 14px", background: "rgba(16,185,129,.05)", border: "1px solid rgba(16,185,129,.15)", borderRadius: 10, display: "flex", alignItems: "center", gap: 10 }}>
                  <svg width="56" height="24" viewBox="0 0 56 24" fill="none">
                    <polyline points="2,20 10,16 18,14 26,10 34,8 42,5 54,2" stroke="#22c55e" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
                    <polygon points="2,20 10,16 18,14 26,10 34,8 42,5 54,2 54,24 2,24" fill="rgba(16,185,129,.08)"/>
                  </svg>
                  <div style={{ fontSize: 12, color: "#22c55e", fontWeight: 700 }}>{tr.landing.reportsGrowth}</div>
                </div>
              </GlassCard>
              ...
              <GlassCard className="rv d2" style={{ padding: "var(--card-pad-lg)", minHeight: "100%" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                  {(tr.landing.reportsProducts as { name: string; clicks: string; clickRate: string; conv: string; convRate: string; sales: string }[]).map((p, i) => {
                    const pColors = ["#22c55e", "#06b6d4", "#22c55e"];
                    const pColor = pColors[i] || "#22c55e";
                    return (
                    <div key={i} style={{ padding: "12px 14px", background: "var(--s2)", border: "1px solid var(--b1)", borderRadius: 12, display: "flex", flexDirection: "column", gap: 8 }}>
                      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                        ...
                        <span style={{ fontSize: 13, fontWeight: 900, color: "#22c55e" }}>{p.sales}</span>
                      </div>
                      <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                        {[
                          ...
                          <div key={j} style={{ display: "flex", gap: 4, alignItems: "center" }}>
                            ...
                            <span style={{ fontSize: 11, color: pColor, background: `rgba(${pColor === "#22c55e" ? "34, 197, 94" : pColor === "#06b6d4" ? "6,182,212" : "16,185,129"},.1)`, padding: "1px 6px", borderRadius: 50 }}>{m.r}</span>
                          </div>
                        ))}
                      </div>
                    </div>
                ...
                <div style={{ marginTop: 14, padding: "10px 14px", background: "rgba(22, 163, 74,.05)", border: "1px solid rgba(22, 163, 74,.12)", borderRadius: 10, fontSize: 12, color: "var(--tm)", textAlign: "center" }}>
            ...
            {/* Bottom banner */}
            <GlassCard className="reports-banner rv d3" style={{ marginTop: 16, padding: "28px 36px", display: "flex", alignItems: "center", gap: 24, borderColor: "rgba(22, 163, 74,.18)" }}>
              <div style={{ width: 52, height: 52, borderRadius: 16, background: "rgba(22, 163, 74,.12)", border: "1px solid rgba(22, 163, 74,.25)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                <svg width="26" height="26" viewBox="0 0 26 26" fill="none">
                  <circle cx="13" cy="13" r="10" fill="rgba(22, 163, 74,.1)" stroke="rgba(34, 197, 94,.4)" strokeWidth="1.5"/>
                  <path d="M13 8v5l3 3" stroke="#22c55e" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
          ...
          <div className="wrap">
            ...
            <div className="tc" style={{ marginTop: 36 }}>
              <button
                ...
                onMouseEnter={(e) => {
                  (e.currentTarget as HTMLButtonElement).style.background = "rgba(22, 163, 74,.2)";
                  (e.currentTarget as HTMLButtonElement).style.borderColor = "rgba(22, 163, 74,.5)";
                  (e.currentTarget as HTMLButtonElement).style.color = "#fff";
                }}
                onMouseLeave={(e) => {
                  (e.currentTarget as HTMLButtonElement).style.background = "rgba(22, 163, 74,.1)";
                  (e.currentTarget as HTMLButtonElement).style.borderColor = "rgba(22, 163, 74,.28)";
                ...
                {faqs.map((f, i) => (
                  <div key={i} className={`fi rv d${(i % 2) + 1}`}>
                    <button
                      ...
                      style={{
                        background:
                          openFaq === i ? "rgba(22, 163, 74,.06)" : "rgba(37, 0, 107, 0.05)",
                        border: `1px solid ${openFaq === i ? "rgba(22, 163, 74,.3)" : "var(--b1)"}`,
