    ...
    <PageShell className="relative overflow-x-clip bg-white" style={{ background: "#fff", color: "#09090b" }}>
      ...
      <section dir={dir} className="relative pt-20 pb-16 md:pt-28 md:pb-20 px-4 border-b border-zinc-200">
        ...
        <div className="container mx-auto relative max-w-4xl text-center">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-purple-100 border border-purple-200 mb-6 rv">
            <span className="relative flex h-1.5 w-1.5">
              <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-violet-500 opacity-75" />
              <span className="relative inline-flex h-1.5 w-1.5 rounded-full bg-violet-500" />
            </span>
            <span className="text-xs font-semibold text-purple-700">{ft.heroTag}</span>
          </div>
          <h1
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-wrap items-center gap-2.5 mb-1">
                        ...
                        <span className="px-2.5 py-0.5 rounded-full bg-purple-100 border border-purple-200 text-[11px] font-bold text-purple-700">
                  ...
                  <div className="grid md:grid-cols-3 gap-5">
                    <div>
                      <div className="text-[11px] font-bold tracking-widest text-purple-600 uppercase mb-2">{ft.descLabel}</div>
                      <p className="text-sm text-zinc-600 leading-relaxed">{isAr ? g.desc : g.descEn}</p>
                    </div>
                    <div>
                      <div className="text-[11px] font-bold tracking-widest text-purple-600 uppercase mb-2">{ft.whenLabel}</div>
                      ...
                      <div className="mt-3 rounded-lg bg-zinc-50 border border-zinc-200 p-3.5 text-sm text-zinc-700 leading-relaxed">
                        <span className="font-bold text-purple-600">{ft.exampleLabel}</span>{isAr ? g.example : g.exampleEn}
                      </div>
                    </div>
                    <div>
                      <div className="text-[11px] font-bold tracking-widest text-purple-600 uppercase mb-2">{ft.expectedResult}</div>
          ...
          <div className="container mx-auto max-w-6xl grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {presentations.map((p, i) => (
              ...
              >
                ...
                <div className="text-xs font-bold text-purple-600">{ft.bestFor}{isAr ? p.best : p.bestEn}</div>
              </div>
            ))}
          </div>
        </section>
                ...
                >
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <div className="text-[11px] font-bold text-purple-600">{ft.activityLabel} <span className="num-ltr">{a.num}</span></div>
                    </div>
                  </div>
