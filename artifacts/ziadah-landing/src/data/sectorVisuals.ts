...
export type SectorMiniProduct = {
  nameAr: string;
  nameEn: string;
  /** The NUMBER only. The unit is the reader's language, not the datum's -
      every one of these used to read "3,400 SAR", so an Arabic page showed an
  ...
  charities: {
    scenarios: [
      ...
      },
      {
        ...
        suggested: [
          { nameAr: "أضف 20 ر.س لوجبة إضافية", nameEn: "Add SAR 20 for a meal", price: "+20", emoji: "➕" },
        ],
        widgetAr: "زيادة مبلغ",
