  ...
  useCases: [
    {
      ...
      exampleEn: "A 200 SAR gift → \"Make it monthly: 200 × 12 covers one student for a year\".",
          widget: {
        titleAr: "شكراً لتبرّعك",
        titleEn: "Thank you for your gift",
        mainAr: "تبرّعك: كفالة طالب",
        mainEn: "Your gift: student sponsorship",
        mainPrice: "200",
        hintAr: "بنفس المبلغ، أفق أطول",
        hintEn: "Same amount, longer horizon",
        suggest: [
          { ar: "200 شهرياً = كفالة سنة كاملة", en: "200 a month = a full year", price: "200/شهر" },
        ],
        ctaAr: "اجعله شهرياً",
        ctaEn: "Make it monthly",
      },
    },
    {
      key: "completion-gap",
      ...
      exampleEn: "A well at 11,600 of 12,000 → \"Finish it with 400 SAR\".",
          widget: {
        titleAr: "أتمّ المشروع",
        titleEn: "Finish the project",
        mainAr: "حفر بئر — 11,600 من 12,000",
        mainEn: "A well - 11,600 of 12,000",
        mainPrice: "—",
        hintAr: "باقي 400 ر.س ويكتمل",
        hintEn: "400 SAR left to complete",
        suggest: [
          { ar: "المبلغ المتبقي", en: "The remaining amount", price: "400" },
        ],
        ctaAr: "أتمّها الآن",
        ctaEn: "Finish it now",
      },
    },
    {
      ...
      exampleEn: "A Ramadan visit → the zakat calculator first, then eligible projects ordered by how close they are to completion.",
        ...
        titleEn: "Your zakat",
        mainAr: "حاسبة الزكاة",
        mainEn: "Zakat calculator",
        mainPrice: "—",
        hintAr: "مشاريع مستحقة للزكاة",
        hintEn: "Zakat-eligible projects",
        suggest: [
          { ar: "كفالة أيتام — مستحق للزكاة", en: "Orphan sponsorship - zakat eligible", price: "—" },
          { ar: "إفطار صائم — مستحق للزكاة", en: "Iftar meals - zakat eligible", price: "—" },
        ],
        ctaAr: "احسب زكاتك",
        ctaEn: "Calculate your zakat",
      },
    },
    {
      key: "impact-report",
      ...
      exampleEn: "A well funded in January → April: \"Your well is running, 40 families\", with no ask attached.",
          widget: {
        titleAr: "أثر تبرّعك",
        titleEn: "What your gift did",
        mainAr: "بئرك — تعمل منذ 3 أشهر",
        mainEn: "Your well - running 3 months",
        mainPrice: "—",
        hintAr: "بلا أي طلب",
        hintEn: "With no ask attached",
        suggest: [
          { ar: "تخدم 40 أسرة يومياً", en: "Serving 40 families daily", price: "—" },
        ],
        ctaAr: "شاهد التقرير",
        ctaEn: "See the report",
      },
    },
    {
      key: "amount-ladder",
      ...
      exampleEn: "100 one basket · 300 three families · 500 a family for a month - with 300 preselected.",
        ...
        mainEn: "Amount",
        mainPrice: "—",
        hintAr: "كل مبلغ بما يفعله",
        hintEn: "Every amount by what it does",
        suggest: [
          { ar: "300 — ثلاث أسر", en: "300 - three families", price: "300" },
          { ar: "100 — سلة غذائية", en: "100 - one basket", price: "100" },
          { ar: "500 — أسرة شهراً كاملاً", en: "500 - a family for a month", price: "500" },
        ],
        ctaAr: "تبرّع",
        ctaEn: "Donate",
      },
    },
    {
      ...
      exampleEn: "A failed charge on 1 May → one blame-free message and a link to update the card.",
          widget: {
        titleAr: "تبرّعك الشهري متوقف",
        titleEn: "Your monthly gift is paused",
        mainAr: "كفالة طالب — 200 شهرياً",
        mainEn: "Student sponsorship - 200/month",
        mainPrice: "200",
        hintAr: "انتهت صلاحية بطاقتك",
        hintEn: "Your card expired",
        suggest: [
          { ar: "تحديث البطاقة", en: "Update the card", price: "—" },
        ],
        ctaAr: "حدّث البطاقة",
        ctaEn: "Update the card",
      },
    },
    {
      key: "cause-match",
      ...
      exampleEn: "A previous student sponsorship → education projects first. Not relief, not mosques.",
          widget: {
        titleAr: "مشاريع التعليم",
        titleEn: "Education projects",
        mainAr: "تبرّعك السابق: كفالة طالب",
        mainEn: "Your last gift: a student",
        mainPrice: "—",
        hintAr: "من نفس القضية",
        hintEn: "In the same cause",
        suggest: [
          { ar: "تجهيز فصل دراسي", en: "Equipping a classroom", price: "1500" },
          { ar: "حقيبة مدرسية × 20", en: "20 school bags", price: "800" },
        ],
        ctaAr: "تبرّع",
        ctaEn: "Donate",
      },
    },
    {
      ...
      exampleEn: "\"An ongoing charity on behalf of my father\" → a card in his name sent to the family.",
          widget: {
        titleAr: "صدقة عن",
        titleEn: "On behalf of",
        mainAr: "صدقة جارية عن والدي",
        mainEn: "An ongoing charity for my father",
        mainPrice: "—",
        suggest: [
          { ar: "بطاقة باسمه تُرسل للعائلة", en: "A card in his name, sent to the family", price: "—" },
        ],
        ctaAr: "تبرّع وأرسل البطاقة",
        ctaEn: "Donate and send the card",
      },
    },
  ],
};
