  ...
  useCases: [
    {
      ...
      exampleEn: "Basket at 41, minimum 50 → \"cookies 8\" or \"a drink 9\", not a 35 SAR dish.",
          widget: {
        titleAr: "ناقصك للحد الأدنى",
        titleEn: "Short of the minimum",
        mainAr: "سلتك",
        mainEn: "Your basket",
        mainPrice: "41",
        hintAr: "9 ر.س وتوصل للحد الأدنى",
        hintEn: "9 SAR to the minimum",
        suggest: [
          { ar: "كوكيز", en: "Cookies", price: "8" },
          { ar: "مشروب غازي", en: "Soft drink", price: "9" },
        ],
        ctaAr: "أضف وأكمل الطلب",
        ctaEn: "Add and continue",
      },
    },
    {
      ...
      exampleEn: "Order leaving the kitchen in 8 minutes → \"Add a dessert before it goes\".",
          widget: {
        titleAr: "قبل ما يخرج",
        titleEn: "Before it leaves",
        mainAr: "برجر كلاسيك — قيد التحضير",
        mainEn: "Classic burger - in preparation",
        mainPrice: "32",
        hintAr: "يخرج من المطبخ خلال 8 دقائق",
        hintEn: "Leaving the kitchen in 8 minutes",
        suggest: [
          { ar: "تحلية اليوم", en: "Today's dessert", price: "18" },
        ],
        ctaAr: "أضفه للطلب",
        ctaEn: "Add to the order",
      },
    },
    {
      key: "reorder-usual",
      ...
      exampleEn: "9pm Thursday → \"The usual: shawarma and a Pepsi\" + \"Try the cheese fries\".",
        ...
        titleAr: "المعتاد",
        titleEn: "The usual",
        mainAr: "شاورما عادي + بيبسي",
        mainEn: "Regular shawarma + a Pepsi",
        mainPrice: "27",
        suggest: [
          { ar: "بطاطس بالجبن — لم تجرّبها", en: "Cheese fries - never tried", price: "16" },
        ],
        ctaAr: "اطلب المعتاد",
    ...
    },
    {
      ...
      exampleEn: "12:30pm from an office location → \"A 6-person platter\" + a basket-sharing link.",
        ...
        hintEn: "Office lunch?",
        suggest: [
          { ar: "صينية 6 أشخاص", en: "A 6-person platter", price: "165" },
        ],
        ctaAr: "شارك السلة",
        ctaEn: "Share the basket",
      },
    },
    {
      ...
      exampleEn: "3 minutes browsing with no order → \"Al-Dana Grills, 25 minutes, 4.7\" - one suggestion.",
        ...
        titleAr: "جرّب هذا",
        titleEn: "Try this",
        mainAr: "لم تطلب بعد — 3 دقائق تصفّح",
        mainEn: "Nothing added yet - 3 minutes browsing",
        mainPrice: "—",
        hintAr: "اقتراح واحد لا قائمة",
        hintEn: "One suggestion, not a list",
        suggest: [
          { ar: "مشويات الدانة — 25 دقيقة، 4.7", en: "Al-Dana Grills - 25 min, 4.7", price: "—" },
        ],
        ctaAr: "افتح القائمة",
        ctaEn: "Open the menu",
      },
    },
    {
      ...
      exampleEn: "8:30pm with a busy kitchen → sandwiches are suggested, not grills.",
          widget: {
        titleAr: "الأسرع الآن",
        titleEn: "Fastest right now",
        mainAr: "المطبخ مزدحم — 8:30 م",
        mainEn: "Busy kitchen - 8:30pm",
        mainPrice: "—",
        hintAr: "مرتّب بوقت التحضير",
        hintEn: "Ranked by preparation time",
        suggest: [
          { ar: "شاورما عادي — 12 دقيقة", en: "Regular shawarma - 12 min", price: "18" },
          { ar: "ساندويتش دجاج — 10 دقائق", en: "Chicken sandwich - 10 min", price: "22" },
        ],
        ctaAr: "أضف للسلة",
        ctaEn: "Add to basket",
      },
