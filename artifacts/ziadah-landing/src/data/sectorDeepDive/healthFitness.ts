  ...
  useCases: [
    {
      ...
      exampleEn: "Whey protein → creatine at 120 + a shaker at 45, not the vanilla version of the same tub.",
          widget: {
        titleAr: "يخدم هدفك",
        titleEn: "Serves your goal",
        mainAr: "بروتين واي 1 كجم",
        mainEn: "1kg whey protein",
        mainPrice: "240",
        hintAr: "بناء عضلة — لا نكهة ثانية",
        hintEn: "Muscle building - not a second flavour",
        suggest: [
          { ar: "كرياتين", en: "Creatine", price: "120" },
          { ar: "شيكر", en: "Shaker", price: "45" },
        ],
        ctaAr: "أضف الكل",
        ctaEn: "Add all",
      },
    },
    {
      ...
      exampleEn: "A 30-serving tub, one a day, bought 1 March → a reminder on 27 March.",
        ...
        titleEn: "Almost out",
        mainAr: "علبة 30 جرعة — اشتُريت 1 مارس",
        mainEn: "30 servings - bought 1 March",
        mainPrice: "240",
        hintAr: "باقي 4 جرعات",
        hintEn: "4 servings left",
        suggest: [
          { ar: "نفس العلبة", en: "The same tub", price: "240" },
        ],
        ctaAr: "أعد الطلب",
        ctaEn: "Reorder",
      },
    },
    {
      ...
      exampleEn: "A third 1kg purchase → \"2.5kg, 6.5 per serving instead of 9.2\".",
          widget: {
        titleAr: "سعر الجرعة",
        titleEn: "Price per serving",
        mainAr: "علبة 1 كجم — شراؤك الثالث",
        mainEn: "1kg tub - your third",
        mainPrice: "240",
        hintAr: "بدل 9.2 للجرعة",
        hintEn: "Instead of 9.2 a serving",
        suggest: [
          { ar: "2.5 كجم — الجرعة 6.5", en: "2.5kg - 6.5 a serving", price: "520" },
        ],
        ctaAr: "خذ الحجم الأكبر",
        ctaEn: "Take the bigger tub",
      },
    },
    {
      key: "equipment-setup",
      ...
      exampleEn: "A 20kg weight set → a floor mat at 180 and a rack at 240, not another machine.",
          widget: {
        titleAr: "لتستخدمها في البيت",
        titleEn: "To actually use it at home",
        mainAr: "أثقال 20 كجم",
        mainEn: "20kg weight set",
        mainPrice: "650",
        suggest: [
          { ar: "حصيرة أرضية", en: "Floor mat", price: "180" },
          { ar: "حامل", en: "Rack", price: "240" },
        ],
        ctaAr: "أضف للسلة",
        ctaEn: "Add to cart",
      },
    },
    {
      ...
      exampleEn: "A new customer → a 1kg protein and a shaker only. No creatine, no burner, no vitamins.",
          widget: {
        titleAr: "ابدأ بسيطاً",
        titleEn: "Start simple",
        mainAr: "عميل جديد",
        mainEn: "New customer",
        mainPrice: "—",
        hintAr: "صنفان فقط، لا حزمة كاملة",
        hintEn: "Two items only, not a stack",
        suggest: [
          { ar: "بروتين 1 كجم", en: "1kg protein", price: "240" },
          { ar: "شيكر", en: "Shaker", price: "45" },
        ],
        ctaAr: "ابدأ بهذين",
        ctaEn: "Start with these two",
      },
    },
    {
      key: "subscription",
      ...
      exampleEn: "The same order in January, February and March → \"Monthly subscription, 10% off, delivered on the 1st\".",
        ...
        mainAr: "نفس الطلب 3 مرات بفواصل منتظمة",
        mainEn: "The same order 3 times, on a rhythm",
        mainPrice: "285",
        suggest: [
          { ar: "اشتراك — 10٪ وتوصيل كل 1 من الشهر", en: "Subscription - 10% off, delivered on the 1st", price: "256", was: "285" },
        ],
        ctaAr: "حوّله لاشتراك",
        ctaEn: "Make it a subscription",
      },
    },
  ],
};
