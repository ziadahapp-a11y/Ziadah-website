  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        timeEn: "7 min",
        sections: [
          { type: "paragraph", text: "الاقتراحات هي قلب منصة زيادة. كل اقتراح هو عنصر ذكي يظهر في متجرك في اللحظة المناسبة ليقترح على العميل منتجات أو عروضاً تزيد من قيمة طلبه." },
