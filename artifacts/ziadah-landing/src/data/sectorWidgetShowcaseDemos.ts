    ...
    ar: {
      buyMoreSaveMore: buyMore(
        ...
        [
          ...
          ["بطاقتان", "خصم 5%", "95"],
          ["٣ بطاقات", "خصم 10٪ + رصيد إضافي", "135"],
        ],
        "100",
        "150",
        "-5%",
    ...
    ar: {
      buyMoreSaveMore: buyMore(
        ...
        [
          ...
          ["٣ جرامات", "خصم مصنعية 10٪ + شهادة", "807"],
        ],
        "570",
        "855",
        "-5%",
    ...
    ar: {
      buyMoreSaveMore: buyMore(
        ...
        [
          ...
          ["كيسان", "خصم 7%", "158"],
          ["٣ أكياس", "خصم 14٪ + توصيل مزرعة", "219"],
        ],
        "170",
        "255",
        "-7%",
    ...
    ar: {
      buyMoreSaveMore: buyMore(
        ...
        [
          ...
          ["باقتان", "خصم 10%", "898"],
          ["٣ باقات", "خصم 18٪ + جلسة مراجعة", "1229"],
        ],
        "998",
        "1497",
        "-10%",
      ...
      addons: {
        items: [
          ...
          { emoji: "📅", name: "متابعة أسبوعية (٤)", price: 800, checked: true },
